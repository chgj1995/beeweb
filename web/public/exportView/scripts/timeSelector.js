...
// datetime-local input에서 시간을 선택하면 URL을 업데이트하고 이벤트를 발생시킴
document.getElementById('startDate').addEventListener('change', searchWithTimePeriod);
document.getElementById('endDate').addEventListener('change', searchWithTimePeriod);
